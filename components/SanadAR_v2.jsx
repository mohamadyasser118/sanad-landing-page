      ...
      >
        ...
        >
          ...
          <div style={{ maxWidth: 660 }}>
            ...
            >
              {[
                ['100', 'مقعد للمحاميين المؤسسين'],
                ['10%', 'عمولة للأشهر الثلاثة الأولى'],
              ].map(([n, l]) => (
                <div
                  key={n}
      ...
      >
        ...
        >
          {[
            ...
            {
              label: 'للمحامين',
              title: 'عمولة 10% للأشهر الثلاثة الأولى',
              desc: 'أول 100 محامٍ يسجّلون يحصلون على عمولة مخفضة 10% لثلاثة أشهر، وشارة المؤسس، وأولوية الظهور في نتائج البحث.',
            },
          ].map((c, i) => (
            <div
              key={i}
